This is taken from <a href="https://projecteuler.net/problem=54">Project Euler</a>. This is intentionally open-ended, so solve it however you like. Keep in mind that the edge cases are particularly tricky for this problem:
